        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="lg:col-span-4 lg:row-end-1">
            ...
            <div className="hidden sm:flex items-start">
              <h3 className="text-sm font-medium text-primary mr-5">Share</h3>
              <ul role="list" className="mb-4 flex items-start space-x-6">
                <li>
            ...
            <div className="hidden sm:flex items-center justify-between pt-2">
                <button className="w-full p-1 mr-2 rounded-2xl border-1 border-dashed border-black dark:border-white font-medium  hover:bg-primary/80">
                    Previous Video
                </button>
                <button className="w-full p-1 ml-2 rounded-2xl font-medium bg-black dark:bg-white text-white dark:text-black hover:bg-primary/80">
                    Next Video
                </button>
            </div>
          </div>
          ...
          <div className="flex sm:hidden items-center mt-2">
            <div className="inline-flex border-1 border-black dark:border-white p-1 px-4 rounded-2xl">
              <h3 className="text-sm font-medium text-primary mr-5">Share</h3>
          ...
          <div className="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-0 lg:max-w-none">
            ...
            <div className="hidden md:block sticky bottom-0 flex-none border-1 border-black rounded-2xl p-8">
                <form>
                    ...
                    <div className="mt-1 flex space-x-4 pt-4 pb-8">
                        <Input
                            ...
                            name="discount-code"
                            type="text"
                            className="block w-full rounded-2xl border-1 border-black shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-md py-2 px-6"
                        />
                        <Button
                            type="submit"
