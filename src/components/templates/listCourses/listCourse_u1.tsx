...
export default function Listcourse() {
  ...
  return (
    <>
    <main className="mt-36 mb-14 lg:mx-16">
                                ...
                                <div className='col-span-5 sm:col-span-7 md:col-span-10 lg:col-span-12 border-t-2 border-black w-full text-center'>
                                    <div className='grid grid-cols-12 gap-4'>
                                        <div className='col-span-4'>
                                            ...
                                            <Button variant="link" className='text-blue-500 whitespace-normal break-words text-center text-xs md:text-base'>download certificate</Button>
                                        </div>
                                        <div className='col-span-4'>
                                            {/* <p className='font-normal text-xs text-blue-500 hover:underline pt-2'>download e-book</p> */}
                                            <Button variant="link" className='text-blue-500 whitespace-normal break-words text-center text-xs md:text-base'>download e-book</Button>
                                        </div>
                                        <div className='col-span-4'>
                                            {/* <p className='font-normal text-xs text-blue-500 hover:underline pt-2'>join this community</p> */}
                                            <Button variant="link" className='text-blue-500 whitespace-normal break-words text-center text-xs md:text-base'>join this community</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
