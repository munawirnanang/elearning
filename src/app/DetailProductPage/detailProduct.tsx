      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8 sm:py-8 lg:max-w-6xl">
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-0 lg:max-w-none">
            ...
            <div className="sticky bottom-0 flex-none ring-1 ring-primary rounded-2xl p-8">
                <form>
                ...
                <div className='mt-4 grid'>
                    <Button variant="destructive" className="rounded-full ring-1 ring-black">Gabung Kelas</Button>
                </div>
            </div>
